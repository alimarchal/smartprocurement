    ...
    <div class="table-responsive">
        <table class="align-middle text-truncate mb-0 table table-borderless table-hover">
            ...
            <tr>
                ...
                <td class="text-center" style="width: 80px;">
                    <img width="40" class="rounded-circle" src="architectui/images/avatars/3.jpg" alt="">
                </td>
                <td class="text-center">
            ...
            <tr>
                ...
                <td class="text-center" style="width: 80px;">
                    <img  width="40" class="rounded-circle" src="architectui/images/avatars/2.jpg" alt="">
                </td>
                <td class="text-center">
            ...
            <tr>
                <td class="text-center text-muted" style="width: 80px;">#56</td>
                <td class="text-center" style="width: 80px;">
                    <img width="40" class="rounded-circle" src="architectui/images/avatars/1.jpg" alt="">
                </td>
                <td class="text-center">
