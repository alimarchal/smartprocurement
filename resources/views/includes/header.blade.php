...
{{--                                <div class="menu-header-image opacity-5" style="background-image: url('architectui/images/dropdown-header/abstract2.jpg');"></div>--}}
...
{{--                                <div class="menu-header-image opacity-1" style="background-image: url('architectui/images/dropdown-header/abstract3.jpg');"></div>--}}
                    ...
                    <div tabindex="-1" role="menu" aria-hidden="true"
                        ...
                        <div class="dropdown-menu-header mb-0">
                            <div class="dropdown-menu-header-inner bg-deep-blue">
                                <div class="menu-header-image opacity-1" style="background-image: url('architectui/images/dropdown-header/city3.jpg');"></div>
                    ...
                    <div tabindex="-1" role="menu" aria-hidden="true"
                        ...
                        <div class="dropdown-menu-header">
                            <div class="dropdown-menu-header-inner pt-4 pb-4 bg-focus">
                                <div class="menu-header-image opacity-05" style="background-image: url('architectui/images/dropdown-header/city2.jpg');"></div>
                                ...
                                <div tabindex="-1" role="menu" aria-hidden="true"
                                    ...
                                    <div class="dropdown-menu-header">
                                        <div class="dropdown-menu-header-inner bg-info">
                                            <div class="menu-header-image opacity-2" style="background-image: url('architectui/images/dropdown-header/city3.jpg');"></div>
                                            <div class="menu-header-content text-start">
                                                <div class="widget-content p-0">
                                                    <div class="widget-content-wrapper">
